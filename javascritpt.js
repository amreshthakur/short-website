function myFunction() {
  ...
  // Start of Testimonials openning tag
...
~ function () {
    ...
    function f(b, c) {
        return new Promise(function (e, h) {
            var f = b.querySelector(".embla"),
                g = b.getAttribute("id"),
                l = f.querySelector(".Profile-containner");
            h = f.querySelector(".Previous__button--prev");
            f = f.querySelector(".Next__button--next");
    ...
    if (document.querySelector("html").classList.contains("is-builder") && u) r(document).on("add.cards", function (a) {
        if (!r(a.target).hasClass("rewiew") || n) return Promise.resolve();
        ...
        (window.initCarouseMultiplePlugin = !0, document.querySelectorAll(".rewiew").forEach(function (a) {
  ...
  // Start of Testimonials closing tag
